...
from .views import poll_list, PollList, PollView, PollVote, PollCreate, PollCreate, PollEdit, OptionCreate,
...
urlpatterns = [
    ...
    path("<int:oid>/edit", OptionCreate.as_view(), name="option_create")
]
